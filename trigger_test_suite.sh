...
echo "[4/4] Triggering CPU Resource Spike (>90% for 15s)..."
curl -s "http://$TARGET_HOST/api/trigger/resource-spike" > /dev/null

echo "=== Trigger sequence complete. Check Fixly Dashboard for live log detection & SSH vitals ==="
